 ...
 * ("496648 NAME", "Name # 6169", "Name #495803"). This only splits out the
...
export function extractIssuedToSignals(raw: string): IssuedToSignals {
  ...
  // "496648 NAME" — leading digit run followed by a name.
  ...
  // "SomeName 6169" — trailing digit run, no separator.
